...
{
    public class Method : BaseInstrumentationTest
    {
        public class Class
        {
        ...
        public Method() : base(typeof(Class).GetMethod(nameof(Class.Method)))
        {
        }
...
IL_000a: ldstr ""MiniCover.UnitTests.Instrumentation.Method/Class""
